        ...
        <header class="topbar" role="banner">
            ...
            <div class="topbar-right">
                <div class="user-avatar-container">
                    ...
                    <a href="subirContenido.php" class="action-btn secondary-btn" title="Gestionar Contenido" style="margin-left: 10px; display:inline-flex; align-items:center; gap:6px;">
                    ...
                    <a href="gestionarUsuario.php" class="action-btn secondary-btn" title="Gestionar Usuarios" style="margin-left: 8px; display:inline-flex; align-items:center; gap:6px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                            ...
                            <path d="M5 8a4 4 0 0 0 0 8"></path>
                        </svg>
                    </a>
                    <?php endif; ?>
            </div>
        ...
        <section id="content-spaces" class="floating-panel" style="left: 350px; top: 80px; width: 420px;" aria-hidden="true">
            ...
            <div class="upload-background-btn-container" style="display:flex; gap:8px; flex-wrap:wrap;">
                ...
                <button id="bulk-delete-toggle-btn" class="action-btn danger-btn">Eliminar Fondos</button>
                                <?php if (!empty($_SESSION['rol']) && $_SESSION['rol'] === 'admin'): ?>
                                    <a href="gestionarUsuario.php" class="action-btn secondary-btn" title="Gestionar Usuarios">Gestionar Usuarios</a>
                                <?php endif; ?>
            </div>
        </section>
